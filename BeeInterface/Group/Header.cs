...
namespace BeeInterface
{
    ...
    public partial class Header : UserControl
    {
        ...
        //    Commons.ItemTool item = new Commons.ItemTool(TypeTool, TypeTool.ToString() + Convert.ToString(G.listAlltool[Global.IndexProgChoose].Count - 1));
        ...
        //    //control.pro.indexTool = G.listAlltool[Global.IndexProgChoose].Count - 1;
        //    BeeCore.Common.CreateTemp(TypeTool);
        //    if (PropetyTool.Name == null) PropetyTool.Name = "";
        //    if (PropetyTool.Name.Trim() == "")
        //        item.name.Text = TypeTool.ToString() + " " + G.listAlltool[Global.IndexProgChoose].Count();
        //    else
        ...
        //    item.lbNumber.Text = G.listAlltool[Global.IndexProgChoose].Count() + "";
       ...
       public bool IsLoad = false;
        public void RefreshListPJ()
        {
            if (G.listProgram == null)
            {
                ...
                G.listProgram.Parent = Global.Main;
   ...
   //         BeeCore.CustomGui.RoundRg(pPO, Global.Config.RoundRad);
           ...
           // ThreadPool.SetMinThreads(Environment.ProcessorCount, Environment.ProcessorCount);
            ...
            Global.Main.Location = new Point(0, 0);
...
txtQrCode.Focus();
        ...
        private void AnimateColumn( System.Windows.Forms.TableLayoutPanel tableLayoutPanel, int columnIndex, bool show)
        {
            ...
            float step = show ? 2F : -2F; // Tang ho?c gi?m kích thu?c
    ...
    public    bool CheckLan()
        {
            string tenMangCanCheck = "LAN"; // Ð?i thành tên card m?ng b?n mu?n ki?m tra
