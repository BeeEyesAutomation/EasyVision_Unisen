...
| --- | --- | --- |
| `BeeCV` | C++/CLI wrappers such as `CCD`, `ColorMaskWrapper`, `MatchingShape`, and `okng_wrapper` exports | OpenCV camera, matching, focus, color mask, and OK/NG helper implementation files |
