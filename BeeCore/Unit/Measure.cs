          ...
          PropetyTool PropetyTool1 = BeeCore.Common.PropetyTools[IndexThread][BeeCore.Common.PropetyTools[IndexThread].FindIndex(a => a.Name == listPointChoose[0].Item1)];
            ...
            if (PropetyTool1 != null)
                ...
                if (PropetyTool1.Results == Results.OK)
                {
                    ...
                    if (index < PropetyTool1.Propety2.listP_Center.Count)
                    {
                        listLine1Point[0] = PropetyTool1.Propety2.listP_Center[index];
                        listRot[0] = PropetyTool1.Propety2.rectRotates[index];
                    }
            ...
            if (PropetyTool2 != null)
                ...
                if (PropetyTool2.Results==Results.OK)
                {
                    ...
                    if (index < PropetyTool2.Propety2.listP_Center.Count)
                    {
                        listLine1Point[1] = PropetyTool2.Propety2.listP_Center[index];
                        listRot[1] = PropetyTool2.Propety2.rectRotates[index];
                    }
            ...
            if (TypeMeasure == TypeMeasure.PointToPoint)
            {
                    ...
                    if (PropetyTool3.StatusTool == StatusTool.Done || !Global.IsRun)
                {
                    ...
                    if (PropetyTool3.Results == Results.OK)
                    {
                        ...
                        if (index < PropetyTool3.Propety2.listP_Center.Count)
                        {
                            listLine2Point[0] = PropetyTool3.Propety2.listP_Center[index];
                            listRot[2] = PropetyTool3.Propety2.rectRotates[index];
                ...
                if (PropetyTool4.StatusTool == StatusTool.Done ||!Global.IsRun )
                {
                    try
                    {
                        ...
                        if (PropetyTool4.Results == Results.OK)
                        {
                            ...
                            if (index < PropetyTool4.Propety2.listP_Center.Count)
                                {
                                    if (PropetyTool4.Name.Contains("Edge"))
                                    {
                                        RectRotate rot = PropetyTool4.Propety2.rectRotates[index];
                                        ...
                                        Point2d pLine1 = new Point2d(PropetyTool4.Propety2.listP_Center[0].X, PropetyTool4.Propety2.listP_Center[0].Y);
                                        Point2d pLine2 = new Point2d(PropetyTool4.Propety2.listP_Center[1].X, PropetyTool4.Propety2.listP_Center[1].Y);
                                    ...
                                    {
                                        listRot[3] = PropetyTool4.Propety2.rectRotates[index];
                                        listLine2Point[1] = PropetyTool4.Propety2.listP_Center[index];
                                    }    
