...
public class English : DefaultLanguage
{
	...
	public override string AuthorizationFailed => "System authorization failed, need to use activation code authorization, thank you for your support. Active device number：" + Authorization.iahsduiwikaskfhishfdi + " If you need commercial authorization, please contact " + DefaultLanguage.Contact;

	public override string InsufficientPrivileges => "The current method interface or class is only open to commercial authorized users with insufficient permissions. Thank you for your support. If you need commercial authorization, please contact " + DefaultLanguage.Contact;
	...
	public override string LogNetCharZero => "\\0 Render";

	public override string LogNetDataTooLittle => "The total amount of data is too small";

	public override string LogNetStartTimeWrong => "The format of the start time is incorrect. Please enter the start time again";

	public override string LogNetFinishTimeWrong => "The format of the end time is incorrect. Please enter the end time again";
	...
	public override string MelsecFxAddressStartWith16 => "The current offset address must be a multiple of 16, for example, M0, M16, X20";

	public override string MelsecFxBoolLength16 => "The length of the bool array currently written must be a multiple of 16";
