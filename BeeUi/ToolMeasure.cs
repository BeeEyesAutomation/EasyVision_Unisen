    ...
    public partial class ToolMeasure : UserControl
    {
        ...
        public void LoadPara()
        {
            ...
            worker.DoWork += (sender, e) =>
            {
                ...
                OutLine outLine3 = G.PropetyTools[G.PropetyTools.FindIndex(a => a.Name == Propety.listPointChoose[2].Item1)].Propety as OutLine;
                OutLine outLine4 = G.PropetyTools[G.PropetyTools.FindIndex(a => a.Name == Propety.listPointChoose[3].Item1)].Propety as OutLine;
       ...
       public bool IsClear = false;
        ...
        private void cb1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (propetyTool.TypeTool != TypeTool.Pattern) return;
